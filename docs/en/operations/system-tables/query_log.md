...
- `type` ([Enum8(\'QueryStart\' = 1, \'QueryFinish\' = 2, \'ExceptionBeforeStart\' = 3, \'ExceptionWhileProcessing\' = 4)](/sql-reference/data-types/enum)) — Type of an event that occurred when executing the query.
...
- `connection_address` ([IPv6](/sql-reference/data-types/ipv6)) — The client IP address from which connection was made.
- `connection_port` ([UInt16](/sql-reference/data-types/int-uint)) — The client port from which connection was made.
...
- `address` ([IPv6](/sql-reference/data-types/ipv6)) — IP address that was used to make the query.
- `port` ([UInt16](/sql-reference/data-types/int-uint)) — The client port that was used to make the query.
