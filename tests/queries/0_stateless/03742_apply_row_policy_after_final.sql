...
CREATE TABLE tab2 (x UInt32, y String, version UInt32) ENGINE = ReplacingMergeTree(version) ORDER BY x SETTINGS index_granularity = 8192;
...
CREATE TABLE tab3 (x UInt32, y String, z UInt32, version UInt32) ENGINE = ReplacingMergeTree(version) ORDER BY x SETTINGS index_granularity = 8192;
...
CREATE TABLE tab4 (x UInt32, y String, version UInt32) ENGINE = ReplacingMergeTree(version) ORDER BY x SETTINGS index_granularity = 8192;
...
CREATE TABLE tab_final (x UInt32, y String, version UInt32) ENGINE = ReplacingMergeTree(version) ORDER BY x SETTINGS index_granularity = 8192;
...
ENGINE = ReplacingMergeTree(version) PARTITION BY y ORDER BY x SETTINGS index_granularity = 8192;
...
ENGINE = ReplacingMergeTree(version) PARTITION BY x ORDER BY x SETTINGS index_granularity = 8192;
...
ENGINE = ReplacingMergeTree(version) ORDER BY toDate(time) SETTINGS index_granularity = 8192;
...
ENGINE = ReplacingMergeTree(version) ORDER BY x SETTINGS index_granularity = 8192;
