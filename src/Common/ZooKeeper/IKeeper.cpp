...
void GetChildrenRecursiveRequest::addRootPath(const String & root_path) { Coordination::addRootPath(path, root_path); }
...
void GetChildrenRecursiveResponse::removeRootPath(const String & root_path)
{
