...
void Context::setUser(const UUID & user_id_, const std::optional<const std::vector<UUID>> & current_roles_, , const std::vector<UUID> & external_roles_)
{
    ...
    access = access_control.getContextAccess(
