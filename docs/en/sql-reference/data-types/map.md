...
| Skip index support | Works with some indexes types created on `mapKeys`/`mapValues`                                 | Skip indexes can only be created on specific path subcolumns, not on all paths/values at once.                                                                                                                                                      |
