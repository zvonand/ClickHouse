...
${CLICKHOUSE_CLIENT} -q "CREATE USER IF NOT EXISTS ${USER1}"
${CLICKHOUSE_CLIENT} -q "CREATE USER IF NOT EXISTS ${USER2} IDENTIFIED WITH plaintext_password BY 'abc'"
${CLICKHOUSE_CLIENT} -q "CREATE ROLE IF NOT EXISTS ${ROLE1}"
${CLICKHOUSE_CLIENT} -q "DROP ROLE IF EXISTS ${ROLE1}"
