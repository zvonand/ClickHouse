...
<!--AUTOGENERATED_START-->
- `code_point` ([String](/sql-reference/data-types/string))
- `code_point_value` ([Int32](/sql-reference/data-types/int-uint))
- `notation` ([String](/sql-reference/data-types/string))
