...
When creating a PR, open it as a **Draft** until it is ready for review — this prevents accidental merges and lets CI run without triggering reviewer notifications.
