...
#define KAFKA_RELATED_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(String, kafka_autodetect_client_rack, "", "Automatically sets client.rack to prefer the nearest Kafka replicas. Supported values: 'AWS_ZONE_ID', 'AWS_ZONE_NAME', 'GCP_ZONE', 'CLICKHOUSE', 'AUTO'. Empty string disables the feature.", 0) \
