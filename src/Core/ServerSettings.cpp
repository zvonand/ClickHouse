...
#define LIST_OF_SERVER_SETTINGS_WITHOUT_PATH(DECLARE, ALIAS) \
    ...
    **Example**
    ...
    DECLARE(UInt64, concurrent_threads_soft_limit_ratio_to_cores, 10, "Same as [`concurrent_threads_soft_limit_num`](#concurrent_threads_soft_limit_num), but with ratio to cores.", 0) \
