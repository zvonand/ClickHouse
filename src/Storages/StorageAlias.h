...
public:
    ...
    StorageMetadataPtr getInMemoryMetadataPtr(ContextPtr query_context, bool bypass_metadata_cache) const override { return getTargetTable()->getInMemoryMetadataPtr(query_context, bypass_metadata_cache); }
