...
_DARWIN_SKIP_TESTS = (
    ...
    "00650_csv_with_specified_quote_rule",
    ...
    "00964_bloom_index_string_functions",
    ...
    "01010_low_cardinality_and_native_http",
    ...
    "01035_enum_conversion_native_format",
    ...
    "01720_country_perimeter_and_area",
    ...
    "02101_empty_as_default_and_omitted_fields",
    ...
    "02560_tuple_format",
    "02562_native_tskv_default_for_omitted_fields",
    ...
    "02907_backup_restore_default_nullable",
    "02907_http_exception_json_bug",
    "02915_analyzer_fuzz_5",
    "02915_lazy_loading_of_base_backups",
    ...
    "02973_block_number_sparse_serialization_and_mutation",
    ...
    "03277_database_backup_database_file_engine",
    ...
    "03315_join_temporary_table_names",
    ...
    "03403_function_tokens_for_like_pattern",
    "03403_parallel_blocks_marshalling_for_distributed",
    "03403_truncate_all_tables_like",
    ...
    "03564_mv_definers_insert_permissions",
    ...
    "03813_size_subcolumn_of_dynamic_subcolumn",
    "03821_remote_grouping_set_aggregation_keys_assert",
    "03822_attach_with_unknown_projection",
    ...
    "04003_interpolate_element_with_alias_formatting",
    "04010_describe_remote_rbac_bypass",
    "04028_csv_input_format",
    "04029_distributed_index_analysis_sampling",
    "04031_row_binary_with_names_columns_input_format",
    ...
    "04099_row_policy_trivial_limit_threads",
    "04102_lightweight_update_v2_smoke",
    "04103_lightweight_update_v2_parallel_read_sort_check",
