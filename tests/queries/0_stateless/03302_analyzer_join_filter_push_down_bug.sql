...
settings enable_analyzer=1, query_plan_remove_unused_columns=1; -- CI may inject False; unused __table2.key column is then not pruned, changing actions/positions throughout the plan
