...
#define DATABASE_ICEBERG_RELATED_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(String, google_adc_credentials_file, "", "Deprecated setting. Path to JSON file containing Google Application Default Credentials. If set, credentials will be loaded from this file. File should contain: type, client_id, client_secret, refresh_token, and optionally quota_project_id", 0) \
