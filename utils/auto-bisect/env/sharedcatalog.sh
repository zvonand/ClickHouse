...
(
  ...
  cp $SCRIPT_DIR/env/config/shared_catalog_config.xml /etc/clickhouse-server/config.d/
  cp $SCRIPT_DIR/env/config/clusters.xml /etc/clickhouse-server/config.d/
  cp $SCRIPT_DIR/env/config/shared_catalog_user.xml /etc/clickhouse-server/users.d/
