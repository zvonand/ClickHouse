...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.5",
        {
            ...
            {"use_top_k_dynamic_filtering_for_variable_length_types", false, false, "New setting to gate `use_top_k_dynamic_filtering` for variable-length types (e.g. `String`)."},
        });
