...
SET join_algorithm = 'hash'; -- CI may inject use_statistics=True with no table stats; missing rhs_size_estimation triggers parallel_hash → ConcurrentHashJoin instead of HashJoin
