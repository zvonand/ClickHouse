...
Allow to choose outer query of simple view for execution with parallel replicas, instead of the view inner query. It can help parallelize query better among nodes)", BETA) \
