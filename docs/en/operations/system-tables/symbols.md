...
<!--AUTOGENERATED_START-->
- `symbol` ([String](/sql-reference/data-types/string)) — Symbol name in the binary. It is mangled. You can apply demangle(symbol) to obtain a readable name.
- `symbol_demangled` ([Nullable(String)](/sql-reference/data-types/nullable)) — Demangled symbol used for XRay instrumentation.
- `function_id` ([Nullable(Int32)](/sql-reference/data-types/nullable)) — Function ID in the XRay instrumentation map.
- `address_begin` ([UInt64](/sql-reference/data-types/int-uint)) — Start address of the symbol in the binary.
- `address_end` ([UInt64](/sql-reference/data-types/int-uint)) — End address of the symbol in the binary.
<!--AUTOGENERATED_END-->
