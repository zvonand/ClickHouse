...
INSERT INTO TABLE FUNCTION s3('http://localhost:11111/test/04065_s3_settings_query_override.csv', 'test', 'testtest', 'CSV', 'number UInt64')
...
WHERE event_date >= yesterday() AND event_time >= now() - 600
    ...
    AND query LIKE '%04065_s3_settings_query_override.csv%'
