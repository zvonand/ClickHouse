...
PRIMARY KEY id
SOURCE(CLICKHOUSE(HOST 'localhost' PORT tcpPort() DATABASE '{CLICKHOUSE_DATABASE_1}' TABLE 'dict2'))
LAYOUT(DIRECT());
...
PRIMARY KEY id
SOURCE(CLICKHOUSE(HOST 'localhost' PORT tcpPort() TABLE 'dict3_source' DATABASE '{CLICKHOUSE_DATABASE_1}'))
LAYOUT(DIRECT());
