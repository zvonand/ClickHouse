...
ContextMutablePtr Session::makeSessionContext()
{
    ...
    /// Set user information for the new context: current profiles, roles (including external), access rights.
    new_session_context->setUser(*user_id, std::nullopt, external_roles);
