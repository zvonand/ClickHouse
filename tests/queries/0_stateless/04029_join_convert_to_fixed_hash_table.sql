...
SET enable_conversion_to_fixed_hash_table = 1;
...
SELECT t_left.id, val, rval FROM t_left ALL INNER JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val, rval FROM t_left ALL INNER JOIN t_right_i64 ON t_left.id = t_right_i64.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val, rval FROM t_left ALL INNER JOIN t_right_neg ON t_left.id = t_right_neg.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val, rval FROM t_left ALL LEFT JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_right_i32.id, val, rval FROM t_left ALL RIGHT JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_right_i32.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val, rval FROM t_left ALL FULL JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val, rval FROM t_left ANY INNER JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val, rval FROM t_left ANY LEFT JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val FROM t_left SEMI LEFT JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
...
SELECT t_left.id, val FROM t_left ANTI LEFT JOIN t_right_i32 ON t_left.id = t_right_i32.id ORDER BY t_left.id SETTINGS enable_conversion_to_fixed_hash_table = 0;
