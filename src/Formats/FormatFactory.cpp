...
FormatSettings getFormatSettings(const ContextPtr & context, const Settings & settings)
{
    ...
    //format_settings.input_format_with_names_case_insensitive_column_matching = settings[Setting::input_format_with_names_case_insensitive_column_matching];
    /*
    DECLARE(FormatSettings::InputFormatCaseSensitivity, input_format_with_names_case_insensitive_column_matching, FormatSettings::InputFormatCaseSensitivity::AUTO, R"(
