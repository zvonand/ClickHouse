...
- `revision` ([UInt32](/sql-reference/data-types/int-uint)) — ClickHouse server build revision.
...
- `symbols` ([Array(LowCardinality(String))](/sql-reference/data-types/array)) — If the symbolization is enabled, contains demangled symbol names, corresponding to the `trace`.
...
- `build_id` — Alias for `\'495FA3F4139606C1CC8F531F40BE7943E5C1336A\'`.
<!--AUTOGENERATED_END-->
