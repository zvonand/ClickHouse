...
public:
    ...
    virtual void chooseDynamicStructureForMerge(const std::vector<Ptr> & /*source_columns*/, std::optional<size_t> /*max_dynamic_subcolumns*/) {}
    ...
    virtual void takeOrCalculateStatisticsFrom(const std::vector<Ptr> & /*source_columns*/) {}
