...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.4",
        {
            ...
            {"enable_join_fixed_hash_table_conversion", true, true, "New setting to enable converting the hash table to a flat array for joins when the key is a single integer with a small value range."},
        });
