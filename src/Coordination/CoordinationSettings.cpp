...
#define LIST_OF_COORDINATION_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt64, max_finished_sessions_cache_size, 100000, "Maximum number of finished sessions to track for stale request filtering. Entries are evicted in FIFO order when the cache is full and a new session needs to be tracked. Set to 0 to disable.", 0) \
