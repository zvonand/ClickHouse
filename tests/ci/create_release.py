...
class ReleaseInfo:
    ...
    def update_version_and_contributors_list(self, dry_run: bool) -> None:
        ...
        with checkout(self.release_branch):
            ...
            # `git commit` exits 1 when there is nothing to commit — this happens
            # on a rerun when the version files were already updated and pushed.
            # Skip silently in that case.
            files_changed = dry_run or not Shell.check(
