...
def test_remove_orphan_files_location(started_cluster_iceberg_with_spark, storage_type):
    ...
    create_orphan_metadata_file(instance, TABLE_NAME, "v0.metadata.json")
    time.sleep(2)
    ...
    assert file_exists(instance, TABLE_NAME, "metadata", "v0.metadata.json"), \
    ...
    assert not file_exists(instance, TABLE_NAME, "metadata", "v0.metadata.json"), \
