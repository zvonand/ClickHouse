...
class Targeting:
    ...
    PASS_WEIGHT_BROAD2        = 0.20  # Pass 4: test covers changed files via very-broad regions (rc 2001-8000)
    ...
    def get_tests_by_changed_lines(self, changed_lines: list,
        ...
        BROAD_FALLBACK_WIDTH = 150  # synthetic width — broad but real coverage
    ...
    def _query_indirect_call_tests(self, primary_result: dict, sparse_files: list | None = None) -> dict:
        ...
        JACCARD_MIN_PCT = max(3, 70 - (200 - min(min_seed_rc, 200)) * 0.5)
        ...
        INDIRECT_LIMIT = max(30, min(200, int(200 * min_seed_rc / 40)))
        ...
        MAX_CALLEE_TEST_COUNT = 220  # callees in >= this many tests are ubiquitous
    ...
    def get_most_relevant_tests(self):
        ...
        MAX_OUTPUT_TESTS = 1000   # hard cap: targeted runs must stay focused
