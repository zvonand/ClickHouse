...
SELECT 1 GROUP BY 1 WITH ROLLUP WITH ROLLUP; -- { serverError SYNTAX_ERROR }
SELECT 1 GROUP BY 1 WITH CUBE WITH CUBE; -- { serverError SYNTAX_ERROR }
SELECT 1 GROUP BY 1 WITH TOTALS WITH TOTALS; -- { serverError SYNTAX_ERROR }
