ATTACH TABLE _ UUID '2c62476d-4419-45ca-b5a9-18bdd36c80db'
(
    ...
    `CurrentMetric_SerializationCacheBytes` Int64 COMMENT 'Total size of the serialization cache in bytes',
    `CurrentMetric_SerializationCacheBytesUncorrected` Int64 COMMENT 'The number of bytes in the serialiation cache including only the values. Doesn\'t count keys and additional overhead from empty slots',
