...
public:
    ...
    Strings getChildrenRecursive(const std::string & path, uint32_t children_nodes_limit = 100000);

    Coordination::Error tryGetChildrenRecursive(const std::string & path, Strings & res, uint32_t children_nodes_limit = 100000);
