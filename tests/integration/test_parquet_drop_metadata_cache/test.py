...
def test_clear_cache_on_cluster(started_cluster):
    node1.query("INSERT INTO TABLE FUNCTION s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', 'Parquet') PARTITION BY number SELECT number FROM numbers(3)")

    node1.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='cold_cache'")
    node2.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='cold_cache'")
    node3.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='cold_cache'")
    ...
    node1.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='hot_cache'")
    node2.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='hot_cache'")
    node3.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='hot_cache'")
    ...
    node1.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='cache_after_drop'")
    node2.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='cache_after_drop'")
    node3.query("SELECT * FROM s3('http://minio1:9001/root/data/test_clear_cache/{_partition_id}.parquet', 'minio', 'minio123', format=Parquet) SETTINGS log_comment='cache_after_drop'")
