...
#define DATABASE_ICEBERG_RELATED_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(String, default_base_location, "", "Base URI under which CREATE TABLE places new tables (e.g. 's3://warehouse/data'). Used when the catalog does not report `default-base-location`", 0) \
