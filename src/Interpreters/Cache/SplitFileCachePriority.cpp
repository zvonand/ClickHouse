    ...
    bool best_effort)
{
    ...
    return getPriority(type).add(key_metadata, offset, size, write_lock, state_lock, best_effort);
}
    ...
    bool best_effort) const
{
    ...
    return getPriority(type).canFit(size, elements, lock, reservee, origin_info, best_effort);
}
