...
$CLICKHOUSE_CLIENT -q "DROP TABLE IF EXISTS t_mergetree_arena SYNC"
$CLICKHOUSE_CLIENT -q "
    CREATE TABLE t_mergetree_arena (a UInt64, b String, c LowCardinality(String), d Float64)
...
# should land in the dedicated MergeTree arena.
for _ in $(seq 1 20); do
    $CLICKHOUSE_CLIENT -q "
        INSERT INTO t_mergetree_arena
...
$CLICKHOUSE_CLIENT -q "DROP TABLE t_mergetree_arena"
